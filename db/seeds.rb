...
Product.create!(title: 'Book', description: 'learn CSS with SASS', price: 19., published: true)
Product.create!(title: 'SBook', description: 'learn CSS with SASS', price: 99, published: true)